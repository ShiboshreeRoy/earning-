...
class IncomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create income" do
    assert_difference("Income.count") do
      post incomes_url, params: { income: { amount: @income.amount, title: @income.title, user_id: @income.user_id } }
    end
  ...
  test "should update income" do
    patch income_url(@income), params: { income: { amount: @income.amount, title: @income.title, user_id: @income.user_id } }
